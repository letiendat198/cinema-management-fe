...
function UserOrder() {
    ...
    return (
        <div className="mt-4">
            <p className="text-3xl font-bold">Pending orders</p>
                    ...
                    return (
                        <div className="flex gap-4 border-gray-400 border-2 p-4 rounded-lg" key={order._id}>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                {order.status == "pending" ? <Button className="self-start mt-auto" onClick={() => redirectToPay(order._id)}>Finish payment</Button> : <></>}
                            </div>
                        </div>
                    )
                })}
